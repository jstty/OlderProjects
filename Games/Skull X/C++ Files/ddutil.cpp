...
//-----------------------------------------------------------------------------
extern "C" DD_SURFACE
DDLoadBitmap(DD_OBJECT pdd, LPCSTR szBitmap, int dx, int dy)
{
    HBITMAP                 hbm;
    BITMAP                  bm;
    DD_SDESC								ddsd;
...
//-----------------------------------------------------------------------------
HRESULT
DDReLoadBitmap(DD_SURFACE pdds, LPCSTR szBitmap)
{
    HBITMAP                 hbm;
    HRESULT                 hr;
...
//-----------------------------------------------------------------------------
extern "C" HRESULT
DDCopyBitmap(DD_SURFACE pdds, HBITMAP hbm, int x, int y,
             int dx, int dy)
{
    HDC                     hdcImage;
    HDC                     hdc;
...
//-----------------------------------------------------------------------------
extern "C" DD_PALETTE
DDLoadPalette(DD_OBJECT pdd, LPCSTR szBitmap)
{
    DD_PALETTE							ddpal;
    int                     i;
    int                     n;
...
//-----------------------------------------------------------------------------
extern "C" DWORD
DDColorMatch(DD_SURFACE pdds, COLORREF rgb)
{
    COLORREF                rgbT;
    HDC                     hdc;
...
//-----------------------------------------------------------------------------
extern "C" HRESULT
DDSetColorKey(DD_SURFACE pdds, COLORREF rgb)
{
    DDCOLORKEY              ddck;
